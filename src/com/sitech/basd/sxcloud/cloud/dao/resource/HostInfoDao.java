...
public interface HostInfoDao {
	 ...
	 * @Description: 使用in语句查询出符合条件的主机集合
	 * @param
	 * @return List<TbCloud2HostInfoObj>
	 * @throws
	 * @author lipengpeng
	 * @version 1.0
	 * @createtime 2013-8-2 上午9:40:13
	 */
	 ...
	 */
	public List<TbCloud2HostInfoObj> queryForListByObjNot(
	 ...
	 */
	public TbCloud2HostInfoObj queryForDistribute(
