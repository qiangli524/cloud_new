...
public class MonitorAlarmObj extends BasePrivilegeObj implements Serializable, Cloneable {
	...
	private String EVENT_SYS;//告警系统 add by lizqd 20140904
	...
	public String getEVENT_SYS() {
		return EVENT_SYS;
	}

	public void setEVENT_SYS(String eVENTSYS) {
		EVENT_SYS = eVENTSYS;
	}
