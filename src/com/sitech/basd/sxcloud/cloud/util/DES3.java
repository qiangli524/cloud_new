...
public final class DES3 extends Cipher {
	...
	static byte[] key = { (byte) 0x12, (byte) 0x34, (byte) 0x45, (byte) 0x78, (byte) 0x87, (byte) 0x34, (byte) 0x43,
			(byte) 0x23, (byte) 0x89, (byte) 0x55, (byte) 0x01, (byte) 0x77, (byte) 0x87, (byte) 0xef, (byte) 0x43,
			(byte) 0x78, (byte) 0xcd, (byte) 0x65, (byte) 0x9a, (byte) 0x21, (byte) 0x12, (byte) 0xab, (byte) 0x56,
			(byte) 0x78, };
	...
	static public String decrypt(String source) {
		 ...
		 */
		/*
		 * if(rt.length()<1) return new String("");
		 */
		return rt;// new String(dec);
	}

	static public void displayString(String source) {
		Logger logger = Logger.getLogger(DES3.class);
