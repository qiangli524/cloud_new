...
public class RealServerForm  {
	...
	private List virtualServerlist = null;
	private String INFO;

	public List getVirtualServerlist() {
		return virtualServerlist;
	}

	public void setVirtualServerlist(List virtualServerlist) {
		this.virtualServerlist = virtualServerlist;
	}
