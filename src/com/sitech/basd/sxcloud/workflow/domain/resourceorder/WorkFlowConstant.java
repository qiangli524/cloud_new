...
public class WorkFlowConstant {
	...
	public static final String FILEKIND_UIP = "UIP"; // UI programs 界面程序

	public static final String FILEKIND_SP = "SP"; // service programs 服务程序

	public static final String FILEKIND_OD = "OD"; // online documents 上线文档
