...
/**
 * 开机任务处理类
 * <p>Title: ResourcePowerOnJob</p>
 * <p> Description:开机任务Job</p>
 ...
 * 
 */
public class ResourcePowerOnJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
		...
		try {
			...
			// 设置执行动作
			operateVMObj.setOperate(VmOperateConstant.POWEREDON);
			// 发送队列消息
			rabbitmqUtil.publishMessage("", QueueDefind.SX_OPERATEVM_QUEUE, operateVMObj);
			logger.info("ResourcePowerOnJob");
