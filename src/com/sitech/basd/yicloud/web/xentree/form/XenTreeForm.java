package com.sitech.basd.yicloud.web.xentree.form;

import java.util.List;

@SuppressWarnings("serial")
public class XenTreeForm {
	...
	private String firstDC_Id;

	public String getFirstDC_Id() {
		return firstDC_Id;
	}

	public void setFirstDC_Id(String firstDC_Id) {
		this.firstDC_Id = firstDC_Id;
	}
