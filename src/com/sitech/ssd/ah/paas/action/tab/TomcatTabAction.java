...
import com.sitech.ssd.ah.paas.domain.tab.TomcatStatisticsObj;
 ...
 * 
 * <p>
 * Title: TomcatTabAction
 * </p>
 * <p>
 * Description: Tomcat相关操作
 * </p>
 * <p>
 ...
 * 
 */
@Controller("tomcatTabAction")
@Scope("prototype")
public class TomcatTabAction extends BaseAction {
	private static final Logger logger = Logger.getLogger(TomcatTabAction.class);
	...
	private TomcatStatisticsObj tomcatStatisticsObj;
	...
	public TomcatStatisticsObj getTomcatStatisticsObj() {
		return tomcatStatisticsObj;
	}

	public void setTomcatStatisticsObj(TomcatStatisticsObj tomcatStatisticsObj) {
		this.tomcatStatisticsObj = tomcatStatisticsObj;
	}
	...
	private PaasEntityObj queryDSAndInstanceCountInBusi(String id) throws Exception {
		...
		List<PaasTreeObj> instanceList = paasTreeService.acquireListForType(
				PaasConstant.MAAS_ENTITY, PaasConstant.TOMCAT, treeObj,
	...
	public String showMiddlewareType() throws Exception {
		...
		paasEntityObj = this.queryBusinessCount_All(id, PaasConstant.TOMCAT, node_type);// 业务数量
