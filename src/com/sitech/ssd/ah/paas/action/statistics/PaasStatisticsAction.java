package com.sitech.ssd.ah.paas.action.statistics;
 ...
 * 
 * <p>
 * Title: PaasStatisticsAction
 * </p>
 * <p>
 * Description: paas资源树摘要相关操作
 * </p>
 * <p>
 ...
 * 
 */
@Controller("paasStatisticsAction")
@Scope("prototype")
public class PaasStatisticsAction extends BaseAction {
	...
	public String caasResourcePool() {
		...
		List<PaasTreeObj> treeList = paasTreeService
				.queryTreeNodeByObj(treeObj1);
		if (treeList != null && treeList.size() > 0) {
			treeObj1 = treeList.get(0);
			PaasTreeObj treeObj2 = new PaasTreeObj();
			treeObj2.setParent_id(treeObj1.getId());
			List<PaasTreeObj> treeList1 = paasTreeService
					.queryTreeNodeByObj(treeObj2);
