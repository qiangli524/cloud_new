...
public class ZooKeeperStatus {
	...
	private Integer watchedPaths;
	private boolean isLeader;
	private String mode;
	private Long nodeCount;
	private String statContent;
	/** 0:不确定 1:OK 2: ERROR*/
	private Long statusType = 0l;
	...
	public Integer getWatchedPaths() {
		return watchedPaths;
	}

	public void setWatchedPaths( Integer watchedPaths ) {
		this.watchedPaths = watchedPaths;
	}

	public Integer getStatusType() {
		return statusType.intValue();
	}

	public void setStatusType( Integer statusType ) {
		this.statusType = statusType.longValue();
	}
