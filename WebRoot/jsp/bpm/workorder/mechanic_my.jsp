	   				...
	   				$(data.list).each(function(i,e){
	   					...
	   					if(statusType=='0'){
		   					html = '<tr>'+
		   								...
		   								'<td >'+e.submitTime+'</td>'+
		   								'<td >'+e.orderLevel+'</td>'+
		   							    '<td style="color:blue" ><a href="<%=path%>'+mechanicUrl[e.resourceName+e.stepId]+'?obj.entryId='+e.entryId+'">查看</a></td>'+
		   							    '</tr>';
	   					}else{
	   						html = '<tr>'+
							'<td >'+e.entryId+'</td>'+
							...
							'<td >'+e.submitTime+'</td>'+
							'<td >'+e.orderLevel+'</td>'+
						    '<td style="color:blue" ><a href="<%=path%>'+mechanicUrl[e.resourceName+2]+'?obj.entryId='+e.entryId+'">查看</a></td>'+
						    '</tr>';
	   					}
			...
			<div class="workorder">
				<div id="tabs" class="ui-tabs ui-widget ui-widget-content">
					<ul id="ul_tabs" class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header">
						 <li>
	                         <a id="statusType0" class="ui-state-default ui-corner-top" href="workorder_mechanic_my.do?statusType=0">待处理工单</a>
	                     </li>
	                     <li>
	                         <a id="statusType1" class="ui-state-default ui-corner-top" href="workorder_mechanic_my.do?statusType=1">已处理工单</a>
	                     </li>
					</ul>		
			</div>
		 </div>
