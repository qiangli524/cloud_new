    ...
    function searchRequest() { 
 	...
 	function listExp(){  
	   /*  var name = obj.PROJECT_NAME.value;
	    ...
	    exportForm.action ="departproject_exportProjectExcel.do?obj.depart_id=" + $("#departId").attr("value");
	    exportForm.submit();
	}
	//添加虚拟机信息
	$(function(){
...
<div class="mainbody">
<s:form action="departproject_listProject.do" id="obj" method="post" cssClass="obj">
	...
	<div class="utt-2 mgt-20">
		<a class="" href="javascript:void(0)" onclick="listExp();return false;" >导出全部</a>
	</div>	
