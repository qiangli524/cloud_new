	...
	$(function(){
	 ...
	 function createDepart(){
		...
		if(!teg.test(ip)){
	 	...
	 	var url = "depart_saveDepart.do?"+str;
	 	api.get("depart").createDepart(url);
	 }
...
<s:hidden name="flag" id="flag"></s:hidden>
		<div class="table-ct" >
			<table width="100%" border="0" cellspacing="0" class="pop-table nosize">
				<tr align="left">
					<td class="til">科室名称</td>
					<td>
						<s:textfield name="obj.name" id="name"></s:textfield>
					</td>
				</tr> 
				 <tr align="left">
					<td class="til">科室负责人</td>
					<td>
						<s:textfield name="obj.leaderName" id="leaderName" readonly="true"></s:textfield><input  type="button" value="选择" name="selectUser"/>
					</td>
				</tr> 
				<%-- <tr align="left">
					<td class="til">预分配CPU核数</td>
					<td>
						<s:textfield name="obj.cpu" id="cpu"></s:textfield>核
					</td>
				</tr> 
				<tr align="left">
					<td class="til">预分配内存</td>
					<td>
						<s:textfield name="obj.mem" id="mem"></s:textfield>G
					</td>
				</tr> 
				<tr align="left">
					<td class="til">预分配存储</td>
					<td>
						<s:textfield name="obj.store" id="store"></s:textfield>G
					</td>
				</tr> 
				<tr align="left">
					<td class="til">预分配IP个数</td>
					<td>
						<s:textfield name="obj.ip_num" id="ip_num"></s:textfield>个
					</td>
				</tr>  --%>
			</table>
		</div>
