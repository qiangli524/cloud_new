...
<script type="text/javascript">
	...
	function submitRequest(){
	  ...
	  var project_id = '<s:property value="vmHostObj.PROJECT_ID" />';
	   ...
	   w.selectAddVM(project_id,vhuuid,connID);
	}
	//通过虚拟机名字,IP,虚拟机类型查询虚拟机
	function queryVM(){
		var project_id = '<s:property value="vmHostObj.PROJECT_ID" />';
		/* $("#vmHostObj.PROJECT_ID").attr("value",project_id); */
/* 		vmHostObj.action='departproject_queryAddVMByObj.do?vmHostObj.PROJECT_ID='+project_id;
*/ 	vmHostObj.submit();	
	}
	//重置
	function resetVM(){
...
<s:form action="departproject_queryAddVMByObj.do" id="vmHostObj" method="post"
	cssClass="vmHostObj">
	<s:hidden name="vmHostObj.PROJECT_ID"></s:hidden>
<div>
	<%-- <div class="query">
	...
	<div class="box on">
		...
		<div class="utt-2 mgt-20"></div>
			<table id="theTable" width="100%" class="blue-table sorttable" border="0" cellspacing="0">
			  ...
			  <tbody>
			    <s:iterator value="remaList" id="theBean">
			  	<tr>
				  	<td>
