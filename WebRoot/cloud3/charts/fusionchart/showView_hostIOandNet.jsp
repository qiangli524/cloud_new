...
<%--		select {margin-top: 10px;margin-right: 10px;margin-bottom: 10px}--%>
    ...
    <script type="text/javascript">
	    ...
	    function updateFusionChartData(){
	    	...
	    	var url="hostMonitor_queryHostDNData_fusion.do?cycle_time="+cycle_time+"&startDate="+startDate+"&endDate="+endDate+"&pointCount="+pointCount
    		...
    		var flag=$("#flag").val();
 	        if(flag=='report'){
	    	    ...
	    	    var pointCount=$("#pointCount option:selected").val();
	    		 ...
	    		 $("#dayChartContainer").insertFusionCharts({
	                 swfUrl: "FusionCharts/ZoomLine.swf", 
	                 dataSource: "hostMonitor_queryHostDNData_fusion.do?cycle_time=oneHour"+"&id="+id+"&kpi="+kpi+"&motionName="+motionName,
	                 dataFormat: "jsonurl", 
	                 width: "730", 
	                 height: "350", 
	                 id: "dayChart"
