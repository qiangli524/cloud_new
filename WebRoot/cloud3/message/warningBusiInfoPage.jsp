...
/*
 ...
 function submitRequest(thisForm){
		...
		thisForm.alarmuserid.value = '<%=request.getAttribute("userId")%>';
		thisForm.subscribe.value = '6';
...
<body class="pop-body scrollbody" onLoad="self.focus();document.theSubscribeForm.sendstyle.focus()">
	<s:form action="message_saveBusiUserWarning.do" method="post"
		...
		<s:hidden name="theSubscribeForm.subscribe" id="subscribe"></s:hidden>
		...
		<table width="100%" border="0" cellspacing="0"
			...
			<tr>
				...
				<td class="til">业务系统<font color="red">*</font>
				</td>
				<td>
