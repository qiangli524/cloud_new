...
<body>
	<div class="demo">
		<div id="tabs">
			<ul>
				<li>
					<a class="tabref"  href="#tabs-1" rel="top_host.do">主机</a>
				</li>
				<li>
					<a class="tabref" href="#tabs-2" rel="top_vm.do">虚拟机</a>
				</li>
				<!--  
				<li>
					<a class="tabref" href="#tabs-3" rel="hyMonitor_hyMonitorData.do?kpi=PM-V-01-010-13&hyId=<s:property value="hyId"/>&motionName=DISK">集群</a>
				</li>
				-->
			</ul>
