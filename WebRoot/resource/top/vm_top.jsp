		...
		<div id="time">
			<table style="width: 100%;height: 20px;border: 0" >
				<tr>
					...
					<td style="font-size:15px;">TOP<input type="text" style="width:30px;color: red" id="num" value="6"/><input type="button" value="GO" onclick="getTops()"/></td>
				</tr>
			</table>
		</div>
		<div id='container2' style="min-width: 700px; height: 350px; margin: 0 auto" align="center"></div>
		<div class="table-ct">
