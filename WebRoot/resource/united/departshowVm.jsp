...
function searchRequest(){
		var project_id = '<s:property value="vmObj.PROJECT_ID" />';
		vmObj.action="unitedOutline_showVMNews.do?vmObj.PROJECT_ID="+project_id;
		vmObj.submit();
	}
	function resetForm(){
		$("#VH_NAME").attr("value","");
...
<body class="pop-body scrollbody" onLoad="self.focus();document.vmObj.VH_NAME.focus()">
<s:form action="" method="post" cssClass="vmObj" id="vmObj">
<div>
	<div class="query">
                ...
                <table width="100%" class="querytable" border="0">
                 <tr>
                    <td class="til">
							...
							<td>
								<s:textfield name="vmObj.VH_NAME" cssClass="txt" id="VH_NAME"></s:textfield>
							</td>
							<td class="til">
								IP地址:
							</td>
							<td>
								<s:textfield name="vmObj.VH_IP" cssClass="txt" id="VH_IP"></s:textfield>
							</td>
							<td class="til">
								虚拟机类型:
							</td>
							<td>
								<s:select list="#{'':'--请选择--','1':'Vmware','3':'XEN'}" name="vmObj.VH_TYPE" id="VH_TYPE"></s:select>
							</td>
                  </tr>
	...
	<div class="blue-wrap noborder" style="bottom:2px;top:100px;left:5px;right:5px;overflow-y:auto;">
		<div class="table-head">
			<jsp:include page="/sxcloud/inc/Pagination.jsp?formId=vmObj" />
		</div>
		<div class="table-ct">
			<table id = "theTable" width="100%" class="blue-table sorttable" border="0" cellspacing="0">
			  ...
			  <tr>
					...
					<th onclick="sort(theTable,1,'string')">虚拟化类型</th>
					...
					<th onclick="sort(theTable,6,'string')">操作系统</th>
			  </tr>
			  </thead>
			  <tbody>
