...
<html>
 ...
 function updatePhysicalVlan(){
 	...
 	var url = "physicalVlan_updatePhysicalVlan.do?"+str;
 	w.updatePhysicalVlan(url);
 }
	...
	function adjustHasVlanId(){
		...
		if($("#vlan_id").attr("value") != "" && $("#vlan_id").attr("value") != null){
			...
			$.ajax({
			         type: "get",
			         url: "vlanAction_adjustHasVlanId.do?vlanId="+vid,
			         dataType: "json",
  ...
  <body  class="pop-body scrollbody">
  	<s:form action="physicalVlan_updatePhysicalVlan.do" method="post" name="addForm" id="addForm" cssStyle="theForm">
  	<div class="table-ct">
			...
			<tr>
				...
				<td>
					<s:textfield cssClass="inpt-2" name="obj.vlan_id" id="vlan_id"   onblur="javascript:adjustHasVlanId();" ></s:textfield>
