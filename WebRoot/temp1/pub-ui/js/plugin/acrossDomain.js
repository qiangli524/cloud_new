...
acrossDomain.prototype.init = function () {
    var self = this;
...
acrossDomain.prototype.send = function (data) {
    this.win.postMessage(data, '*');
};

acrossDomain.initInParent = function (frame) {
    return new this(frame.contentWindow);
};

acrossDomain.initInIframe = function () {
...
if (!window.postMessage && window.attachEvent) {
    ...
    acrossDomain.prototype.initForSameOrigin = function () {
        var self = this;
    ...
    acrossDomain.prototype.sendForSameOrigin = function (data) {
        var self = this;
        setTimeout(function () {
    ...
    acrossDomain.prototype.initForParent = function () {
    ...
    acrossDomain.prototype.initForFrame = function () {
        this.senderWin = null;
    ...
    acrossDomain.prototype.waitForFrame = function () {
        var senderWin;
        var receiverWin;
        try {
    ...
    acrossDomain.prototype.startReceive = function () {
        var self = this;
        this.timerId = setInterval(function () {
            self.tryReceive();
        }, 50);
    ...
    acrossDomain.prototype.tryReceive = function () {
        try {
    ...
    acrossDomain.prototype.receive = function () {
        var rawData = null;
        try {
    ...
    acrossDomain.prototype.flush = function () {
        var dataList = [];
