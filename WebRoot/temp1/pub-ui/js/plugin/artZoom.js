...
$.fn.artZoom = function (option) {
	option = $.extend({}, $.fn.artZoom.defaults, option);
	...
	this.live('click', function (event) {
		...
		var $artZoom, buttonClick,
			...
			maxWidth = option.maxWidth || ($parent[0].nodeName === 'A' ? $this.parent() : $this).parent().width(),
			maxHeight = option.maxHeight || 99999;
		
		maxWidth = maxWidth - option.borderWidth;
...
$.fn.artZoom.defaults = {
	path: '../css/' + uedSkin + '/images/artZoom',
	left: '\u5de6\u65cb\u8f6c',
	right: '\u53f3\u65cb\u8f6c',
	source: '\u770b\u539f\u56fe',
	hide: '\xd7',
