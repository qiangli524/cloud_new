  ...
  <head>
    ...
    <script type="text/javascript">
	    $(document).ready(function(){
	    	var uuid = $("#uuid").val();
	    	 $("#PowerNetCardPerformanceChart").insertFusionCharts({
                 swfUrl: "FusionCharts/MSLine.swf", 
                 dataSource: "ibmtab_queryIBMIndex.do?uuid="+uuid+"&flag=PowerNetCardPerformance",
                 dataFormat: "jsonurl", 
                 width: "800", 
                 height: "400", 
                 id: "PowerNetCard"
  ...
  <body> 
	...
	<s:hidden name="uuid"></s:hidden>
  	<table>
  		<tr>
  			<td>
  				<div id="PowerNetCardPerformanceChart">网卡流量监控</div>
  			</td>
  		</tr>
  	</table>
  </body> 
