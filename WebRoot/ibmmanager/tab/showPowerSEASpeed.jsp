  ...
  <head>
    ...
    <script type="text/javascript">
	    $(document).ready(function(){
	    	var uuid = $("#uuid").val();
	    	 $("#PowerSEASpeedChart").insertFusionCharts({
                 swfUrl: "FusionCharts/MSLine.swf", 
                 dataSource: "ibmtab_queryIBMIndex.do?uuid="+uuid+"&flag=PowerSEASpeed",
                 dataFormat: "jsonurl", 
                 width: "800", 
                 height: "400", 
                 id: "SEAChart"
  ...
  <body> 
	...
	<s:hidden name="uuid"></s:hidden>
  	<table>
  		<tr>
  			<td>
  				<div id="PowerSEASpeedChart">网络性能信息</div>
  			</td>
  		</tr>
  	</table>
  </body> 
