...
<s:hidden id="cluid" name="cluid"></s:hidden>
<s:hidden id="cluuuid" name="cluuuid"></s:hidden>
<div>
<table width="98%" border="0" cellspacing="0" cellpadding="0" >
  <tr>
    <td align="left" valign="top" class="panel-datacenter">
       <h2 class="cluster1"></h2>
        <div class="clr"></div>
            <div class="box on">
              <dl class="single">
              	<dt>
    ...
    <td align="left" valign="top" class="panel-resource">
	        ...
	        <table width="400" border="0" cellspacing="0" cellpadding="0" class="font-14 mgt-10">
	          <tr>
		            <td width="50%"><img src="<%=request.getContextPath()%>/sxcloud/images/virtual/blue.gif" width="16" height="16" />&nbsp;&nbsp;总数: 
