...
<script type="text/javascript">
	...
	$(function(){
		 api.button({
		     id:'OkAnd',
		     name: '确定',
		     callback:addMiddlewareBusiness,
		     focus: true
		 },
		 {
		     id:'cancle',
		 ...
		 $("[name='selectBmt']").click(function(){
	    		...
	    		w.$.dialog({
	    			...
	    			height: '500px',
	    		    lock:true,
	    			content: 'url:paasTree_getBusniessList.do?jspName=addMiddlewareBusiness'
	    			});
	          });		 
	});
	...
	function addMiddlewareBusiness(){
		...
		w.saveMiddlewareBusiness(parentId,$("#treeObj").serialize());
		return true;
	}
</script>
</head>
