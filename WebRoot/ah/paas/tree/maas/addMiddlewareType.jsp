...
<script type="text/javascript">
	...
	function addMiddlewareType(){
		...
		w.saveMiddlewareType(parentId,$("#treeObj").serialize());
		return true;
	}
</script>
</head>
	...
	<s:hidden name="treeObj.parent_id" id="parent_id"></s:hidden>
		<div>
			...
			<tr>
				...
				<td width="70%">
					<s:select list="#{'2':'Tomcat','5':'Weblogic' }" name="treeObj.server_type" id="server_type" style="width: 50%"></s:select>
				</td>
			</tr>
		</table>
		</div>
