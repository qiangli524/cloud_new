...
<script type="text/javascript">
	...
	function addDBType(){
		...
		w.saveMiddlewareEntity(parentId,$("#treeObj").serialize());
		return true;
	}
	...
	$(function(){
		...
		$("[name='selectMidEntity']").unbind().live("click",function(){
				w.$.dialog({
	    			id:'addMidInstance',
	    			title:'选择实体',
	    			width: '800px',
	    			height: '500px',
	    		    lock:true,
	    			content: 'url:paasTree_listMiddlewareEntity.do?treeObj.server_type='+server_type+'&treeObj.parent_id='+parent_id
		    		});
			 });
	});

	function listMiddlewareEntity(entity_id,entity_name){
			...
			class="pop-table nosize">
				<tr>
					...
					<td>
						...
						<span class="ubtn-1 mgl-20"><input type = "button"  value = "选择" name="selectMidEntity" /></span>
					</td>
				</tr>
			</table>
		</div>
