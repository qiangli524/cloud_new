...
$(function(){
	 ...
	 function addChildSys(){
		...
		w.saveChildSys(parentId,$("#theForm").serialize());
		return true;
	}
});
</script>
...
<body class="pop-body scrollbody">
	<s:form action="" method="post" styleId="theForm" id="theForm">
		...
		<table width="100%" border="0" cellspacing="0" class="pop-table nosize">
			<tr>
				<td class="til">子系统名称:<font color="red">*</font></td>
				<td >
				<s:textfield  name="paasBusiTreeObj.name" cssClass="txt" id="objName" ></s:textfield>
				</td>
			</tr>
			<%-- <tr>
				<td class="til">是否显示zookeeper信息:</td>
				<td >
					<select id="sel" name="paasBusiTreeObj.zookFlag">
