                      ...
                      <tr>
                        ...
                        <td>
                        	...
                        	<s:else>
	                        	...
	                        	<s:else>
		                        	<div class="percentage"><b style='width:<s:property value="@java.lang.Math@round(cpuUsedRate)"/>%'></b></div>
	                        	</s:else>
                        	</s:else>
                        </td>
                        <td>
                	...
                	<table width="230" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td>
                        	...
                        	<s:else>
                        		<div class="percentage"><b style='width:<s:property value="@java.lang.Math@round(menUsedRate)"/>%'></b></div>
                        	</s:else>
                        </td>
                        <td>
