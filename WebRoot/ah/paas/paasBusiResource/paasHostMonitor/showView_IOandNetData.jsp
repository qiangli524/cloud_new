    ...
    <script type="text/javascript">
	    ...
	    function updateFusionChartData(){
	    	...
	    	$("#dayChartContainer").updateFusionCharts({
               dataSource: "paasHostMonitor_queryHostDNData_fusion.do?cycle_time="+cycle_time+"&startDate="+startDate+"&endDate="+endDate+"&pointCount="+pointCount
    	...
    	function insertFusionChartData(){
    		 $("#dayChartContainer").insertFusionCharts({
                 ...
                 dataSource: "paasHostMonitor_queryHostDNData_fusion.do?cycle_time=oneHour"+"&id="+id+"&kpi="+kpi+"&motionName="+motionName+"&eq_type="+eq_type,
                 dataFormat: "jsonurl", 
                 width: "730", 
                 height: "350", 
                 id: "dayChart"
