...
<script type="text/javascript">
	$(function(){
		...
		$.ajax({
			type:"post",
			url:"weblogicTab_showHealthLimitChart.do?id="+id+"&node_type="+node_type,
			dataType:"json",
			async:false,
			cache:false,
			success:function(data){
				var resultXml = data.jsonXml;	
				var chart = new FusionCharts("FusionCharts/AngularGauge.swf","chat","350","200","0","1");
	...
	function showDBInstance(entity_id,coll_time,timeline){
		 $.dialog({
	       		id:'show',
	       		title:'信息',
	       		height:'550px',
	       		width:'900px',
	       		lock:true,
	       		content:'url:paasTree_tabs.do?node_type=34&server_type=52'+'&entity_id='+entity_id+'&coll_time='+coll_time+'&timeline='+timeline
	       	});
	}
	//健康度历史
	function showAverage(){
		...
		$.ajax({
			type:'get',
			dataType:'text',
			url:'weblogicTab_showLimitAverage.do?id='+id+'&node_type='+node_type+"&start_time="+start_time+"&end_time="+end_time+'&cycle_time='+time,
	...
	function showInstanceList(busi_id,entity_id,cycle_time,coll_time,timeline){
		$.ajax({
			type:'post',
			dataType:'json',
			url:'weblogicTab_showInstanceListForBusiNode.do?id='+busi_id+'&coll_time='+coll_time+'&cycle_time='+cycle_time,
			success:function(data){
...
<body class="pop-body scrollbody">
	...
	<s:form action="" method="post"  id="theForm">
		...
		<div class="mainboxservice" style="overflow-y: auto;width: 100%;">
			<div class="item" style="width: 98%;">
				<div class="top">
					<div class="ml5"><font color="orange" size="3">实例指标健康度</font></div>
				</div>
				<div>
						...
						<table width="100%" class="ued-table" border="0" cellspacing="0" id="tab" >
							...
							<tbody>
								<s:iterator value="resultList" id="theBean">
									<tr>
										<td style="padding-left: 30px;" entity_id="<s:property value='#theBean.entity_id'/>">
		...
		<div class="mainboxDaas" style="width: 100%;">
			<div class="item" style="width:94.2%;border: 0px solid #FFFFFF;">
	  			<div class="top">
	  				<div class="ml5"><font color="orange" size="3">历史业务健康度</font>
						<span>
					  		时间：
	...
	<div class="mainboxservice" style="overflow-y: auto;width: 100%;display: none;" id="mainboxservice">
			<div class="item" style="width: 98%;">
			<div class="top">
					<div class="ml5"><font color="orange" size="3">实例列表</font></div>
			</div>
			<div>
				<div class="right"  style="width: 100%;margin-bottom: 5px;margin-top: 10px;">
