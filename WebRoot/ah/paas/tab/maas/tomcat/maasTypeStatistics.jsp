...
<script type="text/javascript">
	...
	function showBusiTopN(){
		...
		$.ajax({
			type:'get',
			dataType:'text',
			url:'tomcatTab_showBusiTopN.do?id='+id+'&node_type='+node_type+'&top_num='+top_num,
	...
	function showChart(busiId){
		...
		$.ajax({
			type:"post",
			url:"tomcatTab_showBusiChart.do?id="+busiId,
			dataType:"json",
	...
	function showLimitChar(busiId){
		...
		$.ajax({
			type:"post",
			url:"tomcatTab_showHealthLimitChart.do?id="+busiId+"&node_type="+node_type,
			dataType:"json",
			async:false,
			cache:false,
			success:function(data){
