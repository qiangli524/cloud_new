...
<script type="text/javascript">
	$(function(){
		...
		$.ajax({
			type:"post",
			url:"tomcatTab_showHealthLimitChart.do?id="+id+"&node_type="+node_type,
			dataType:"json",
			async:false,
			cache:false,
	...
	function showAverage(){
		...
		$.ajax({
			type:'get',
			dataType:'text',
			url:'tomcatTab_showLimitAverage.do?id='+id+'&node_type='+node_type+"&start_time="+start_time+"&end_time="+end_time+'&cycle_time='+time,
	...
	function showInstanceList(busi_id,entity_id,cycle_time,coll_time,timeline){
		$.ajax({
			type:'post',
			dataType:'json',
			url:'tomcatTab_showInstanceListForBusiNode.do?id='+busi_id+'&coll_time='+coll_time+'&cycle_time='+cycle_time,
			success:function(data){
