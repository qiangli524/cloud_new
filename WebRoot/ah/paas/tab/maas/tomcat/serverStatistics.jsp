...
$(function(){
	...
	$("input[name=checkboxId]").change(function(){
			...
			$("#average1").updateFusionCharts({
 	        	dataSource:'tomcatTab_showInstanceChartByEntityId.do?entity_id='+entity_id+'&name='+entity_name+"&cycle_time="+time
 	      });
		});
	...
	function showAverage(){
		...
		$("#average1").insertFusionCharts({
                    ...
                    dataSource: 'tomcatTab_showLimitAverage.do?id='+id+"&cycle_time="+time,
                    dataFormat: "jsonurl", 
                    width: "94.2%", 
                    height: "280", 
                    id: "chart1"
	...
	function queryChart(){
    	...
    	var time = $("#time option:selected").val();
		$("#average1").updateFusionCharts({
 	        	dataSource:'tomcatTab_showLimitAverage.do?id='+id+"&start_time="+start_time+"&end_time="+end_time+"&cycle_time="+time
 	      });
	}
	...
	function queryServerList(){
		...
		$.ajax({
			type:'post',
			dataType:'json',
			url:'tomcatTab_queryInstanceListByName.do?paasEntityObj.entity_name='+instanceName+'&id='+id+'&cycle_time='+time,
