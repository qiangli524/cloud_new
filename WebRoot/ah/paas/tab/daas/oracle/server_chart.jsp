...
<link href="<%=request.getContextPath()%>/ah/paas/statistics/css/statistics.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript">
    	...
    	function showCharts(){
    		...
    		var url = "oracleTab_listServerCharts.do?kpi_type="+kpi_type+"&entity_id="+entity_id;
    		...
    		if(kpi_type == "efficiency"){
    			$("#efficiency").insertFusionCharts({
                    ...
                    dataSource: "oracleTab_listServerCharts.do?kpi_type="+kpi_type+"&entity_id="+entity_id+"&cycle_time="+time_efficiency,
                    dataFormat: "jsonurl", 
                    width: "700", 
                    height: "346", 
                    id: "chart1"
    			...
    			$("#response").insertFusionCharts({
                    swfUrl: "FusionCharts/ZoomLine.swf", 
                    dataSource: "oracleTab_listServerCharts.do?kpi_type="+kpi_type+"&entity_id="+entity_id+"&cycle_time="+time_response,
                    dataFormat: "jsonurl", 
                    width: "700", 
                    height: "346",  
                    id: "chart2"
    			...
    			$("#resource").insertFusionCharts({
                    swfUrl: "FusionCharts/ZoomLine.swf", 
                    dataSource: "oracleTab_listServerCharts.do?kpi_type="+kpi_type+"&entity_id="+entity_id+"&cycle_time="+time_resource,
                    dataFormat: "jsonurl", 
                    width: "700", 
                    height: "346", 
                    id: "chart3"
