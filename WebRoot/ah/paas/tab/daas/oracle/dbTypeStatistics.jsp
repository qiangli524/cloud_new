...
<script type="text/javascript">
	...
	function showBusiTopN(){
		...
		$.ajax({
			type:'get',
			dataType:'text',
			url:'oracleTab_showBusiTopN.do?id='+id+'&node_type='+node_type+'&top_num='+top_num,
	...
	function showChart(busiId){
		...
		$.ajax({
			type:"post",
			url:"oracleTab_showBusiChart.do?id="+busiId,
			dataType:"json",
			success:function(data){
				$("#entity_name").text(data.paasObj.nodeName);
       			$("#dbCount").text(data.paasObj.dbCount);
       			$("#instanceCount").text(data.paasObj.instanceCount);
       			$("#serverCount").text(data.paasObj.serverCount);
       			...
       			if (resultList != null) {
					for ( var i = 0; i < resultList.length; i++) {
						...
						var health_score_availability = resultList[i].health_score_availability;
						...
						if(health_score_availability == null || health_score_availability == ""){
	...
	function showLimitChar(busiId){
		...
		$.ajax({
			type:"post",
			url:"oracleTab_showHealthLimitChart.do?id="+busiId+"&node_type="+node_type,
			dataType:"json",
			async:false,
			cache:false,
			success:function(data){
				var resultXml = data.jsonXml;	
				var chart = new FusionCharts("FusionCharts/AngularGauge.swf","ChartId"+busiId,"350","180","0","1");
...
<body>
	...
	<div class="mainboxBus" style="overflow-y: auto;width: 100%;border: solid 0px #FFFFFF;" >
		...
		<div class="item" style="width:98%;border: 0px solid #FFFFFF;">
  			<div class="top">
  				<div class="ml5"><font color="orange" size="3" style="margin-right: 70%;">业务</font>
  					TOP<input type="text" style="width:30px;color: red" id="topnum" value="8"/>
		...
		<div class="mainboxDaas" style="border: solid 0px #FFFFFF;">
			...
			<div class="item" style="width: 46.5%;">
				...
				<div>
					<div class="right">
						<ul class="dc-list">
							<li style="width: 135px;">
		            			<i class="zhuji"></i><span class="txt">数据库:</span><span class="num blue-num"><font style="font-weight:bold;" id="dbCount"><s:property value="paasEntityObj.dbCount"/></font></span>
		            		</li>		
		     			</ul>  
						<ul class="dc-list">
							<li style="width: 135px;">
		            			<i class="zhuji"></i><span class="txt">数据库实例:</span><span class="num blue-num"><font style="font-weight:bold;" id="instanceCount"><s:property value="paasEntityObj.instanceCount"/></font></span>
		            		</li>		
		        			<li style="width: 100px;">
		            			<i class="running"></i><span class="txt">正常</span><span class="num blue-num"><font style="font-weight:bold;" id="normalCount"><s:property value="paasEntityObj.normalCount"/></font></span>
		        			</li>
		        			<li style="width: 100px;">
		           				<i class="alert"></i><span class="txt">异常</span><span class="num red-num"><font style="font-weight:bold;" id="unusualCount"><s:property value="paasEntityObj.unusualCount"/></font></span>
		         			</li>
		     			</ul>  
		     			<ul class="dc-list">
							<li style="width: 135px;">
		            			<i class="zhuji"></i><span class="txt">数据库服务:</span><span class="num blue-num"><font style="font-weight:bold;" id="serverCount"><s:property value="paasEntityObj.serverCount"/></font></span>
		            		</li>		
		     			</ul>  
					</div>
				</div>
					...
					<div class="right">
		     			<ul class="dc-list">
		        			...
		        			<li>
								...
								<a href="javascript:;" onclick="serious('1')"><span id="mainAlarmCount"><s:property value="paasEntityObj.mainAlarmCount"/></span></a></font></span>
		        			</li>
							<li>
		            			<i class="zhuji"></i><span class="txt">次要告警:</span><span class="num blue-num"><font style="font-weight:bold;" id="minorAlarmCount">
								<a href="javascript:;" onclick="serious('2')"><span id="minorAlarmCount"><s:property value="paasEntityObj.minorAlarmCount"/></span></a></font></span>
		            		</li>		
		        			<li>
		            			<i class="zhuji"></i><span class="txt">不确定告警:</span><span class="num blue-num"><font style="font-weight:bold;" id="otherAlarmCount">
		            			<a href="javascript:;" onclick="serious('3')"><span id="otherAlarmCount"><s:property value="paasEntityObj.otherAlarmCount"/></span></a></font></span>
		        			</li>
		     			</ul> 
					</div>
				</div>
