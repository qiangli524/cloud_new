...
<script type="text/javascript">
	...
	function showBusiTopN(){
		...
		$.ajax({
			type:'get',
			dataType:'text',
			url:'mysqlTab_showBusiTopN.do?id='+id+'&node_type='+node_type+'&top_num='+top_num,
	...
	function showChart(busiId){
		...
		$.ajax({
			type:"post",
			url:"mysqlTab_showBusiChart.do?id="+busiId,
			dataType:"json",
	...
	function showLimitChar(busiId){
		...
		$.ajax({
			type:"post",
			url:"mysqlTab_showHealthLimitChart.do?id="+busiId+"&node_type="+node_type,
			dataType:"json",
			async:false,
			cache:false,
			success:function(data){
				var resultXml = data.jsonXml;	
				var chart = new FusionCharts("FusionCharts/AngularGauge.swf","ChartId"+busiId,"350","200","0","1");
				...
				<div class="right">
					<ul class="dc-list">
						<li style="width: 150px;">
	            			<i class="zhuji"></i><span class="txt">数据库实例:</span><span class="num blue-num"><font style="font-weight:bold;"><s:property value="paasEntityObj.dbCount_all"/></font></span>
	            		</li>		
			...
			<div class="item" style="width: 46.5%;">
				...
				<div>
					<div class="right">
						<ul class="dc-list">
							<li style="width: 135px;">
		            			<i class="zhuji"></i><span class="txt">数据库实例:</span><span class="num blue-num"><font style="font-weight:bold;" id="instanceCount"><s:property value="paasEntityObj.dbCount"/></font></span>
		            		</li>		
		        			<li style="width: 100px;">
