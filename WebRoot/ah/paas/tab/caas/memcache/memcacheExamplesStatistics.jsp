	...
	$(function(){
		...
		var node_type = $("#node_type").val();
		 $("#getHits").insertFusionCharts({
             ...
             dataSource: "memcacheTab_showHits.do?entity_id="+entity_id+"&node_type="+node_type+"&flag=get",
             dataFormat: "jsonurl", 
             width: "64", 
             height: "64", 
             id: "getHit"
		 ...
		 $("#deleteHits").insertFusionCharts({
             swfUrl: "FusionCharts/Pie2D.swf", 
             dataSource: "memcacheTab_showHits.do?entity_id="+entity_id+"&node_type="+node_type+"&flag=delete",
             dataFormat: "jsonurl", 
             width: "64", 
             height: "64", 
             id: "deleteHit"
		 ...
		 $("#incrHits").insertFusionCharts({
             swfUrl: "FusionCharts/Pie2D.swf", 
             dataSource: "memcacheTab_showHits.do?entity_id="+entity_id+"&node_type="+node_type+"&flag=incr",
             dataFormat: "jsonurl", 
             width: "64", 
             height: "64", 
             id: "incrHit"
		 ...
		 $("#decrHits").insertFusionCharts({
             swfUrl: "FusionCharts/Pie2D.swf", 
             dataSource: "memcacheTab_showHits.do?entity_id="+entity_id+"&node_type="+node_type+"&flag=decr",
             dataFormat: "jsonurl", 
             width: "64", 
             height: "64", 
             id: "decrHit"
		 ...
		 $("#casHits").insertFusionCharts({
             swfUrl: "FusionCharts/Pie2D.swf", 
             dataSource: "memcacheTab_showHits.do?entity_id="+entity_id+"&node_type="+node_type+"&flag=cas",
             dataFormat: "jsonurl", 
             width: "64", 
             height: "64", 
             id: "casHit"
		 ...
		 $("#touchHits").insertFusionCharts({
             swfUrl: "FusionCharts/Pie2D.swf", 
             dataSource: "memcacheTab_showHits.do?entity_id="+entity_id+"&node_type="+node_type+"&flag=touch",
             dataFormat: "jsonurl", 
             width: "64", 
             height: "64", 
             id: "touchHit"
	...
	<s:form action="" method="post"  id="theForm">
		...
		<div class="mainboxBus" style="width: 100%">
			...
			<div class="item" style="width: 48%">
				<div class="top">
					<div class="ml5"><font color="orange" size="3">基本信息</font></div>
				</div>
				<div>
					<div class="right">
						<ul class="dc-list">
							<s:iterator value="resultList" id="theBean">
								<s:if test="#theBean.type_kpi=='211'">
									<li>
			...
			<div class="item" style="width: 48%">
				<div class="top">
					<div class="ml5"><font color="orange" size="3">连接数</font></div>
				</div>
				<div>
					<div class="right">
						<ul class="dc-list">
							<s:iterator value="resultList" id="theBean">
								<s:if test="#theBean.type_kpi=='212'">
									<li>
				            			<i class="zhuji"></i><span class="txt" style="width: 142px;">
				            			<s:property value="#theBean.desc_kpi"/>:</span>
				            			<span class="num blue-num"><font style="font-weight:bold;"><s:property value="#theBean.kpi_value_last"/></font></span>
			...
			<div class="item" style="width: 48%">
				<div class="top">
					<div class="ml5"><font color="orange" size="3">进程</font></div>
				</div>
				<div>
					<div class="right">
						<ul class="dc-list">
							<s:iterator value="resultList" id="theBean">
								<s:if test="#theBean.type_kpi=='2113'">
									<li>
				            			<i class="zhuji"></i><span class="txt" style="width: 142px;">
				            			<s:property value="#theBean.desc_kpi"/>:</span>
				            			<span class="num blue-num"><font style="font-weight:bold;"><s:property value="#theBean.kpi_value_last"/></font></span>
			...
			<div class="item" style="width: 48%">
				<div class="top">
					<div class="ml5"><font color="orange" size="3">认证</font></div>
				</div>
				<div>
					<div class="right">
						<ul class="dc-list">
							<s:iterator value="resultList" id="theBean">
								<s:if test="#theBean.type_kpi=='2114'">
									<li>
				            			<i class="zhuji"></i><span class="txt" style="width: 142px;">
				            			<s:property value="#theBean.desc_kpi"/>:</span>
				            			<span class="num blue-num"><font style="font-weight:bold;"><s:property value="#theBean.kpi_value_last"/></font></span>
			...
			<div class="item" style="width: 48%">
				<div class="top">
					<div class="ml5"><font color="orange" size="3">hash</font></div>
				</div>
				<div>
					<div class="right">
						<ul class="dc-list">
							<s:iterator value="resultList" id="theBean">
								<s:if test="#theBean.type_kpi=='2115'">
									<li>
				            			<i class="zhuji"></i><span class="txt" style="width: 142px;">
				            			<s:property value="#theBean.desc_kpi"/>:</span>
				            			<span class="num blue-num"><font style="font-weight:bold;"><s:property value="#theBean.kpi_value_last"/></font></span>
			...
			<div class="item" style="width: 48%">
				<div class="top">
					<div class="ml5"><font color="orange" size="3">其他</font></div>
				</div>
				<div>
					<div class="right">
						<ul class="dc-list">
							<s:iterator value="resultList" id="theBean">
								<s:if test="#theBean.type_kpi=='2116'">
									<li>
				            			<i class="zhuji"></i><span class="txt" style="width: 142px;">
				            			<s:property value="#theBean.desc_kpi"/>:</span>
				            			<span class="num blue-num"><font style="font-weight:bold;"><s:property value="#theBean.kpi_value_last"/></font></span>
