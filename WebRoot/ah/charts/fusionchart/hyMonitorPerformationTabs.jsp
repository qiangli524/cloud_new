...
<div id="tabs" style="position:absolute;bottom:2px;top:2px;left:5px;right:5px;overflow-y:auto;">
	<ul>
		...
		<li><a class="tabref" href="#tabs-1" rel="ah-hyMonitor_hyMonitorPerformation.do?kpi=PM-V-01-010-11&hyId=<s:property value="hyId"/>&motionName=CPU" >CPU</a></li>
		<li><a class="tabref" href="#tabs-2" rel="ah-hyMonitor_hyMonitorPerformation.do?kpi=PM-V-01-010-12&hyId=<s:property value="hyId"/>&motionName=MEMORY">内存</a></li>
	</ul>
	<!-- tab switching -->
	<div id="tabs-1">
    </div>
