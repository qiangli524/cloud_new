...
<%-- <script type="text/javascript" src="<%=request.getContextPath() %>/ah/boss/monitor/tree/js/bossTree.js"></script> --%>
<%-- <script type="text/javascript" src="<%=request.getContextPath() %>/ah/boss/monitor/tree/js/rMenu.js"></script> --%>
...
<script type="text/javascript">
	...
	var setting = {
		...
		async : {
			enable : true,
			dataType: "json",
			url : "bossTreeAction_asyncForTree.do",//异步加载树
			autoParam : [ "name","type","isParent","parent_name","grand_name"]
		}
	};
	/* zTreeNodes = [
	...
	function onClick(event, treeId, treeNode, clickFlag) {
		...
		$("#right_iframe").attr(
					"src",
					"bossTreeAction_tabs.do?obj.type="+treeNode.type+"&obj.name="+treeNode.name+"&obj.parent_name="+treeNode.parent_name+"&obj.grand_name="+treeNode.grand_name);
...
<s:form action="" method="post" id="theForm">
	<div class="content_wrap">
		...
		<div class="right">
			<div id="iframe">
				<iframe id="right_iframe" src="bossTreeAction_tabs.do" name="xxxx" height="100%" width="81%" frameborder="0" style="position:fixed;left:229px;right:0px;top:0px;bottom:0px;overflow-y:auto;border:none;background：#fff;"></iframe>
			</div>
		</div>
	</div>
	<div id="rMenu">
