...
<script type="text/javascript">
	...
	function initData(){
		...
		if(uid == "" || uid == null){
			$.ajax({
					type : 'post',
					url : 'bossBusiAction_queryHosiChartJSONForLog.do?obj.CLUSTER_NAME='+
	...
	function desc(a){
			...
			$.dialog({
					...
					height: '450px',
					lock:true,
					content: 'url:bossBusiAction_queryListForErrorLogDesc.do?obj.CLUSTER_NAME='+cluster
...
<body style="overflow-y:auto;height: 730px;">
<div class="mainbody">
<s:form action="bossBusiAction_queryListForErrorLog.do" method="post" cssStyle="theForm" id="theForm">
<s:hidden name="kpi"></s:hidden>
		 <div class="pd-20 bgcolor-1">
		 	<h2 class="utt-1">错误日志监控</h2>
			<div class="bord-1 pd-20">			
			<div class="clearfix mgt-10">
				<label class="vm">集群名称：</label>
					<s:select cssStyle="width:110px;" list="obj.clusterList" cssClass="select-1 vm" id="CLUSTER_NAME"  
