...
<div id="tabs" style="position:absolute;bottom:2px;top:2px;left:5px;right:5px;">
	<ul>
		...
		<li><a class="tabreff" href="#tabs-1" rel="bossBusiAction_queryMonitorDataListOfPort.do?kpi=PM-01-01-001-05">当前数据</a></li>
		<li><a class="tabref" href="#tabs-2" rel="bossBusiAction_queryHosiPortDataList.do?kpi=PM-01-01-001-05">历史数据</a></li> 
	</ul>
	<div id="tabs-1">
    </div>
    <div id="tabs-2"> 
