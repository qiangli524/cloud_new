...
<script type="text/javascript">
    ...
    function showHyMonitorPerformationTabs(hyId){
    	...
    	$.dialog({
		    ...
		    content:'url:hyMonitor_highChartsTabs.do?hyId='+hyId+'&startDate='+startDate+'&endDate='+endDate+'&flag=report'
		});
    }
    function listExp(){
    	var url = "vmReportForm_sh_vmPerformanceExport.do?"+$("#theForm").serialize()
...
<body >
<div class="mainbody" >
<s:form action="vmReportForm_SHQueryVmPerformance.do" method="post" cssClass="theForm" id="theForm">
	...
	<div class="pd-20 bgcolor-1">
        ...
        <div class="bord-1 pd-10" >
                <table  width="100%" class="blue-table sorttable" border="0" >
				  ...
				  <tr>
                    <td width="15%" >虚拟机名称:</td>
                    <td align="left">
                    	<s:textfield name="vf.vmName" cssStyle="width:150px;"  flag="text"></s:textfield>
                    </td>
                    <td width="15%">业务名称：</td>
                    <td align="left">
                    	<s:textfield name="vf.busi" cssStyle="width:150px;" flag="text"></s:textfield>
                    </td>
                  </tr>
<%--                  <tr>--%>
...
<%--							</th>--%>
				...
				<tbody>
				  <s:iterator value="vmReportFormList" id="theBean">
				  	<tr>
				  		<td> 
				  			<div class="hidden" title='<s:property value="#theBean.vmName"/>'>
								<s:property value="#theBean.vmName"/>
							</div>
				  		</td>
				  		<td>
