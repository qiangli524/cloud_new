...
<div style=" float: left"><%=tag %></div>
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr class="monitor_bg1">
					<td width="300px" class="tab_grey tabfocus" >
		...
		<s:form action="reporthost_getHostCurrentReportView.do" method="post" id="theForm" cssClass="theForm">
			...
			<div id="chartContainer5" style="float:left;margin-left: 10px">
				FusionCharts will load here!
			</div>
			<script type="text/javascript"><!--              
