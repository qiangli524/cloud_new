...
<body class="pop-body scrollbody">
    <s:form action="workorder/workorder_selectHost.do" method="post" id="theForm" cssStyle="theForm">
            ...
            <table id="theTable" width="100%" border="0" cellspacing="0" class="blue-table sorttable">
                ...
                <tbody>
                	<s:iterator value="hostList" id="theBean">
                		<tr >
                			<td>
                				<input type="checkbox" host_id='<s:property value="#theBean.h_uuid" />' 
                				host_name='<s:property value="#theBean.eq_name" />'
                				connectid='<s:property value="#theBean.connectId" />'/>
                			</td>
                			<td>
                				<s:property value="#theBean.eq_name"></s:property>
                			</td>
                			<td>
                				<s:property value="#theBean.eq_ip"></s:property>
                			</td>
                		</tr>
                	</s:iterator>
                </tbody>
