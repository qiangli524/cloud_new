...
<body class="pop-body scrollbody">
	<s:form action="workorder/workorder_listWorkOrder.do" method="post" id="theForm" cssStyle="theForm">
		<div>
			<div class="query">
								...
								<s:iterator value="resultList" id="theBean">
					  				<tr>
										...
										--%><td uuid='<s:property value="#theBean.UUID"/>' states='<s:property value="#theBean.STATE"/>'
											typer = '<s:property value="#theBean.TYPE"/>' projectid = '<s:property value="#theBean.PROJECT_ID"/>'
