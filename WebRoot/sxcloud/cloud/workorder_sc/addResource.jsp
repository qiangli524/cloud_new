		...
		$("#selectClu").click(function(){
			...
			w.$.dialog({
				id:'addclu',
	  			...
	  			height: '550px',
	  		    lock:true,
	  			content: 'url:workorder/workorder_selectCluster.do?oper='+oper
			});
		});
		...
		$("#chooseIP").click(function(){
			...
			w.$.dialog({
				id:'addIP',
	  			...
	  			height: '470px',
	  		    lock:true,
	  			content: 'url:workorder/workorder_selectIp.do?net_id='+netid+'&oper='+oper
			});
		});
		...
		<div>
			<table width="100%" border="0" cellspacing="0" class="pop-table nosize">
				...
				--%><tr>
					...
					<td>
						<s:textfield name="workOrderObj.TEMPLATENAME" id="temname" readonly="true"></s:textfield>
						<input type="button" class="thickbox btn-style02" value="选择" id="chooseTem"/>
					</td>
				</tr>
				<tr>
					<td>模板类型</td>
				...
				<tr>
					...
					<td>
						<s:textfield name="workOrderObj.CPU_NUM" id="cpu"></s:textfield>
					</td>
				</tr>
				<tr>
					<td>内存大小<font color="red">*</font></td>
					<td>
						<s:textfield name="workOrderObj.MEM_SIZE" id="memsize"></s:textfield>G
					</td>
				</tr>
				<tr>
					<td>存储大小<font color="red">*</font></td>
					<td>
						<s:textfield name="workOrderObj.SR_SIZE" id="srsize"></s:textfield>G
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>网络子域<font color="red">*</font></td>
					<td>
				...
				<tr>
					<td>VLAN<font color="red">*</font></td>
					<td>
						<select id="netid" name="workOrderObj.NETWORK_ID" >
				...
				<tr>
					...
					<td>
						...
						<s:textfield name="workOrderObj.PROJECT_NAME" readonly="true" id="projectname"></s:textfield>
						<input type="button" class="thickbox btn-style02" value="选择" id="choosePRO"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						...
						<s:textfield name="workOrderObj.PROJECT_USER_NAME" readonly="true" id="projectusername"></s:textfield>
					</td>
				</tr>
				<!-- ----------------------------------------- -->
				<tr id="showBusi">
					...
					<td>
						...
						<s:textfield name="workOrderObj.resParentBusiSystemName" id="resParentBusiSystemName" disabled="true"></s:textfield>
						<input type="button" class="thickbox btn-style02" value="选择" id="chooseBusi"/>
					</td>
				</tr>
				<tr id="showSubBusi">
					<td>
					...
					<td>
						...
						<s:textfield name="workOrderObj.resBusiSystemName" id="resBusiSystemName" disabled="true"></s:textfield>
						<input type="button" class="thickbox btn-style02" value="选择" id="chooseSubBusi"/>
					</td>				
				</tr>
				<tr>
					<td>
						资源目录：<font color="red">*</font>
					</td>
					<td>
						<s:textfield name="workOrderObj.resAppDir" id="resAppDir"></s:textfield>
					</td>
				</tr>
				<tr>
					<td>
						资源目录大小(G)：<font color="red">*</font>
					</td>
					<td>
						<s:textfield name="workOrderObj.resAppSize" id="resAppSize"></s:textfield>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<s:textfield name="workOrderObj.VM_NAME" id="vmname" onfocus="randomVmName()" cssStyle="width:350px;"></s:textfield>
