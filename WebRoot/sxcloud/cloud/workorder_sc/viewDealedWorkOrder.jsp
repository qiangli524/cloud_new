		...
		$(function(){
			...
			$("[name='viewResource']").unbind().live("click",function(){
				...
				$.dialog({
					...
					width: '1300px',
					height: '600px',
					content: 'url:workorder/workorder_listResource.do?uuid='+uuid+'&state='+state+'&wstat='+wstat
				});
			});
		});
						...
						<table id="theTable" width="100%" class="blue-table sorttable" border="0" cellspacing="0">
							<thead>
								<tr>
									...
									<th onclick="sort(theTable,4,'string')">任务总数</th>
									<th onclick="sort(theTable,5,'string')">成功</th>
									<th onclick="sort(theTable,6,'string')">失败</th>
									<th onclick="sort(theTable,7,'string')">待处理</th>
									<th onclick="sort(theTable,8,'string')">处理中</th>
									<th onclick="sort(theTable,9,'string')">未挂存储</th>
									<th onclick="sort(theTable,10,'string')">查看任务</th>
								</tr>
							</thead>
							<tbody>
