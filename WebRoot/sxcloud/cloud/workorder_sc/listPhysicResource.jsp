...
<body>
	<div class="mainbody">
		<s:form action="workorder/workorder_listResource.do" method="post"
			...
			<div class="pd-20 bgcolor-1">
				...
				<div class="utt-2 mgt-20">
					<a class="icon-add" href="javascript:void(0)" id="addForm">新增</a> <a
						class="icon-modify" href="javascript:void(0)" id="editForm">编辑</a>
				...
				<table id="theTable" width="100%" class="blue-table sorttable"
					...
					<thead>
						<tr>
							...
							<th onclick="sort(theTable,3,'string')">设备类型</th>
							<th onclick="sort(theTable,5,'string')">CPU个数</th>
							<th onclick="sort(theTable,6,'string')">内存大小</th>
							<th onclick="sort(theTable,7,'string')">存储大小</th>
							<th onclick="sort(theTable,8,'string')">数量</th>
							<!--  
					...
					<tbody>
						<s:iterator value="resultList" id="theBean">
							<tr>
								...
								<td><s:property value="#theBean.CPU_NUM" />个</td>
