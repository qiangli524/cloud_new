...
<%--	数字校验--%>
	...
	function submitRequest(thisForm){ 
			 ...
			 if(thisForm.virtualIP.value.length ==0){
	  	 	 ...
	  	 	 if(thisForm.sourceIPFrom.value ==0){
	     		alert("sourceIPFrom不能为空！");
	    		thisForm.sourceIPFrom.focus;
	   	 		return false  ;
	  	 	 }
	  	 	 if(thisForm.farmName.value ==0){
	     		alert("Farm名称不能为空！");
	    		thisForm.farmName.focus;
	   	 		return false  ;
	  	 	 } 
	  	 	 if(thisForm.l4Protocol.value ==0){
	     		alert("l4Protocol不能为空！");
	    		thisForm.l4Protocol.focus;
	   	 		return false  ;
	  	 	 }
	  	 	 if(thisForm.l4Port.value ==0){
	     		alert("l4Port不能为空！");
...
<s:form action="L4Policy_savel4Policy.do" method="post" id="theForm">
		...
		<div>
			<table width="100%" border="0" cellspacing="0" class="pop-table nosize">
				...
				<tr>
					...
					<td>
						<s:textfield  name="theForm.l4Port" id="l4Port"/>  
					</td>
					<td class="til">
				...
				<tr>
					...
					<td>
						<s:select name="theForm.l4Protocol" list="#{'1':'TCP','2':'UDP','3':'ICMP',
						'4':'SCTP','5':'Any','6':'Other'}" id="l4Protocol">
					 	</s:select> 
					</td>
					<td class="til">
				...
				<tr>
					...
					<td>
						<s:textfield name="theForm.sourceIPFrom" id="sourceIPFrom"/> 
					</td>
					<td class="til">
