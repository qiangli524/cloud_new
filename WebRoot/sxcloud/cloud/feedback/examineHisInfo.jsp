  		...
  		<s:hidden name="pfbForm.action_type" value=""/>
			<table width="100%" border="0" cellspacing="0" class="pop-table nosize">
				<tr>
					...
					<td>
					    <s:textfield  name="pfbForm.SUBMIT_TIME"  styleClass="input disable" readonly="true" />
    				</td>
				</tr>
				<tr>
				...
				<tr>
  					<td class="input_bg">确认信息内容：</td>
    				<td class="input_bg" colspan="3"><s:textarea name="pfbForm.HF_INFO" cols="40" rows="3"  styleClass="input disable" readonly="true" /></td>
				</tr>
				<tr>
  					<td class="input_bg">反馈时间：</td>
    				<td class="input_bg" colspan="3"><s:textfield name="pfbForm.HF_TIME"  styleClass="input disable" readonly="true" /></td>
				</tr>
				<tr>
