...
String.prototype.Trim  = function(){return this.replace(/^\s+|\s+$/g,"");}
	...
	function checkValid(obj){
		...
		if (!checkEmpty(obj.TITLE,'标题')) return false;
...
<jsp:include page="/common/title.jsp" flush="true"/>
			<div id="frame">
		  <div class="tableheadbg"><img src="images/dot_tablehead.gif" width="13" height="13">反馈信息修改<span class="darkblue"></span>
