...
<head>
   ...
   function selectPro(){
	   ...
	   api.get(openerId).selectPro(proid,proleader,projectname,projectusername);
   }
...
<body class="pop-body scrollbody">
	<div class="mainbody">
		<s:form action="workorder/workorder_selectProject.do" method="post"
			...
			<div class="pd-20 bgcolor-1">
				<div class="bord-1 pd-10">
					<div class="clearfix mgt-10">
						...
						<s:textfield name="projectObj.PROJECT_NAME" id="project_name"
							...
							<s:iterator value="projectList" id="theBean">
								<tr>
									<td><input type="checkbox"
										...
										projectname="<s:property value='#theBean.PROJECT_NAME'/>" />
									</td>
									<td><s:property value="#theBean.PROJECT_NO" />
									</td>
									...
									<td><s:property value="#theBean.PROJECT_LEADERNAME" />
									</td>
									...
									<td><s:property value="#theBean.IP_COUNT" />
									</td>
									<td><s:property value="#theBean.NETNAME" />
									</td>
								</tr>
							</s:iterator>
						</tbody>
