...
<body style="overflow-y:auto;">
	<div class="pd-20 bgcolor-1">
		<div class="bord-1 pd-10">
			<s:form action="" method="post" id="workOrderObj" cssStyle="theForm"
				name="workOrderObj" cssClass="pdt-10">
				...
				<div>
					<table width="100%" border="0" cellspacing="0"
						...
						<tr>
							...
							<td><s:select list="#{'0':'申请','1':'调整','2':'回收' }" name="type"
									id="typer" onchange="showBusi()" cssClass="select-1 width:60"></s:select>
							</td>
						</tr>
						<tr>
							<td class="til" align="left">工单标题： <font color="red"
								size="1">*</font></td>
							<td><s:textfield name="workOrderObj.WORK_ORDER_TITLE"
									id="title" cssClass="inpt-1 vm"></s:textfield></td>
						</tr>
						<tr>
							<td class="til" align="left">备注：</td>
							<td><s:textarea cols="15" rows="5"
