...
<script type="text/javascript">
   ...
   function searchRequest() { 
 	...
 	//    theForm.flag.value = 1;
 	    ...
 	    //theForm.TEM_ID.value = tem;
 	    theForm.action = 'templet_releaseTemplet.do?TEM_ID='+tem_id;
		theForm.submit();
 	}
...
<body>
<s:form action="templet_listReleaseTemplet.do" method="post" cssStyle="theForm" id="theForm">
<div class="scrollbody">
	...
	<div class="blue-wrap noborder">
		<div class="table-head">
		    <ul class="btns">
				<li><input type="button" class="thickbox btn-style02" value="发布" onclick = "releaseRequest();return false;" /></li>
			</ul>
