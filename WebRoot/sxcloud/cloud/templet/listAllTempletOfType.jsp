...
<script type="text/javascript">
	function cancleRequest(){
		...
		var couterNum = 0;
 	    ...
 	    theForm.action = 'templet_cancleBindingImage.do?ID='+id+'&NAME='+name;
		theForm.submit();
	}
...
<body>
<s:form  cssClass="theForm" id="theForm">
<s:hidden name="theTempletForm.ID" id="ID"></s:hidden>
<s:hidden name="theTempletForm.NAME" id="name"></s:hidden>
<div class="tit-zzi">
		<div id="zi"><s:property value="theTempletForm.NAME"/>类型镜像</div>
		<div id="zi"></div>
</div>
		...
		<div class="table-ct">
			...
			<tr>
				<td colspan="4" class="btnCenter">
					<input type="button" class="thickbox btn-style02" value="取消绑定" 
						onclick ="javascript:cancleRequest();return false;" />
