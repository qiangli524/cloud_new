...
<script type="text/javascript">
	...
	function submitRequest(){
		theForm.action = 'templet_saveReleaseTemplet.do'
		theForm.submit();
	}
...
<s:form action="templet_releaseTemplet.do" method="post" cssClass="theForm" id="theForm">
<s:hidden name="theForm.TEM_NAME"></s:hidden>
<s:hidden name="theForm.TYPE"></s:hidden>
<s:hidden name="theForm.TEM_DESC"></s:hidden>
<!-- 
<html:hidden name="theForm" property="TEM_NAME" />
 <html:hidden name="theForm" property="TYPE" />
  <html:hidden name="theForm" property="TEM_DESC" />
   -->
			...
			<table width="100%" border="0" cellspacing="0" class="pop-table nosize">
				<tr>
					...
					<td>
						...
						<s:hidden  name="theForm.TEM_ID"></s:hidden>
					</td>
				...
				<tr>
					...
					<td>
						<s:text name="theForm.TEM_DESC"></s:text>
					</td>
				</tr>
				<tr>
					<td class="til">
					...
					<td>
                    	<s:select list="#{1:'发布',2:'废弃'}" name="theForm.RELEASE_FLAG"></s:select>
					</td>
					<td class="til">
					</td>
					<td>
