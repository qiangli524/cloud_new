...
<%--	数字校验--%>
	...
	function resetForm(theForm){ 
		...
		theForm.serverAddress.value = '0.0.0.0';
		theForm.serverPort.value = '';
...
<body class="pop-body scrollbody">
	<s:form action="farmserver_savefarmServer.do" method="post" id="theForm">
				...
				<div>
					<table width="100%" border="0" cellspacing="0"
						...
						<tr>
							...
							<td>
								<s:textfield name="theForm.serverAddress" id="serverAddress"/>
							</td>
							<td class="til">
								Server Port:
								<font style="color:#FF3401">*</font>
							...
							<td colspan="3">
								<s:textfield name="theForm.serverPort" id="serverPort"/>
							</td>
						</tr>
						<tr>
							<td class="til">
							...
							<td>
								<s:textfield property="theForm.serverDescription" id="serverDescription"/>
							</td>
							<td class="til">
								Admin Status:
								<font style="color:#FF3401"></font>
			...
			<div>
				<table width="100%" class="pop-table nosize" border="0"
					...
					<tr>
						...
						<td>
							<s:select name="theForm.farmNameForLocalFarm" list="theForm.farmList" listKey="farmName" listValue="farmName" id="farmName">
							</s:select>
						</td>
					</tr>
					<tr>
