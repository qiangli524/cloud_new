...
<script type="text/javascript">
    ...
    function searchRequest() { 
 	...
 	function addRequest() {
 	    ...
 	    theForm.action = 'config_addGlobalConfig.do' 
		theForm.submit();
 	}
    ...
    $(function(){ 
	    $("[name='add']").unbind().live("click",function(){ 
    		$.dialog({
    			...
    			height: '400px',
    		    lock : true,
    			content: 'url:'+basePath+'config_addGlobalConfig.do'
    		});
        });
        ...
        $("[name='mod']").unbind().live("click",function(){ 
    		...
    		$.dialog({
    			...
    			height: '400px',
    			lock: true,
    			content: 'url:'+basePath+'config_modGlobalConfig.do?'+$("#theForm").serialize()
    		});
        });
 	...
 	function modRequest() { 
 	    ...
 	    theForm.action = 'config_modGlobalConfig.do' 
		theForm.submit();
 	}
 	function delRequest() {
 	var couterNum = 0;
 	   ...
 	   alert("请勾选一条信息");
 	    ...
 	    theForm.action = 'config_delGlobalConfig.do'  
		theForm.submit();
 	    }
 	}
</script>
...
<div class="mainbody">
	<s:form action="config_listGlobalConfig.do" method="post" cssClass="theForm" id="theForm">
	<s:hidden name="theForm.ID" id="ID"></s:hidden>
		<div class="pd-20 bgcolor-1">
       		<h2 class="utt-1">全局配置管理</h2>
                <div class="bord-1 pd-10">			
				<div class="clearfix mgt-10">
                    <label class="vm">配置关键字：</label>
					<s:textfield name="theForm.KEY" cssClass="inpt-1 vm" id="KEY" maxlength="30"></s:textfield>
                    <label class="vm">配置描述：</label>
					<s:textfield name="theForm.CFG_DESC" cssClass="inpt-1 vm" id="CFG_DESC" maxlength="100"></s:textfield>
			...
			<table id="theTable" width="100%" class="blue-table sorttable" border="0" cellspacing="0">
			  ...
			  <tr>
				   <th>选择</th>
				   <th onclick="sort(theTable,1,'string')">配置关键字</th>
				   <th onclick="sort(theTable,2,'string')">配置值</th>                
                   <th onclick="sort(theTable,3,'string')">配置描述</th>
                   <!--  
                   <th>类型:</th>
                   <th>连接地址:</th>
                   <th>重复加载模式:</th>
			  ...
			  <s:iterator value="theForm.resultList" id="theBean">
			  	<tr>
			  		...
			  		<td width="170"> 
			  			<div class="hidden" title='<s:property value="#theBean.KEY"/>'>
