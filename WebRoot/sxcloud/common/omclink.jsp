...
<link href="<%=request.getContextPath()%>/sxcloud/bomc/Contents/css/common.css" rel="stylesheet" type="text/css" />
<link href="<%=request.getContextPath()%>/sxcloud/bomc/Contents/css/style.css" rel="stylesheet" type="text/css" />


<script type="text/javascript" src="<%=request.getContextPath()%>/sxcloud/cjs/jquery/jquery-1.3.2.min.js"></script>
