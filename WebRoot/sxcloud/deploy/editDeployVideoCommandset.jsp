...
<body class="pop-body scrollbody">
	<html:form action="saveDeployVideoCommandset" method="post" styleId="theForm">
		...
		<html:hidden name="theForm" property="ID" />
			<table width="100%" border="0" cellspacing="0" class="pop-table nosize">
				...
				<tr>
					...
					<td colspan="3"><html:textarea style="background:black;color:white" property="resultStr" cols="77" rows="10"></html:textarea>
					</td>		
				</tr>
