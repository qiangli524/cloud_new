...
<body>
	<s:form action="example_upgradeExampleResumeList.do" method="post" id="theForm">
					...
					<div class="table-ct">
						<table id="theTable" width="100%" class="blue-table sorttable" border="0"
							...
							<thead>
								<tr>
									<th>
										<input name="allcheckbox" type="checkbox" onclick="selectAll()" />
									</th>
							...
							<tbody>
									<s:iterator id="theBean" value="theForm.resultList">
										<tr>
											...
											<td style="width: 150px"><a style="color: black;" class="font-more"
											 title='<s:property value="#theBean.DEPLOYPATH"/>' >
											<s:property value="#theBean.DEPLOYPATH"/></a></td>
											<td>
