...
<script type="text/javascript">
	...
	function submitRequest(){ 
		...
		if(!isnumber(swap_size)){
			alert("HDFS存储总容量只能为大于或等于0的数字");
			return false;
		}
		if(ip==""){
			alert("请填写IP地址");
       ...
       var url = "hadoopHostInfo_saveHostInfo.do?"+$("#hostInfoObj").serialize();
       w.saveHadoophost(url);
	}
...
<body class="pop-body scrollbody">
	<s:form action="hadoopHostInfo_saveHostInfo" method="post" id="hostInfoObj" >
		<s:hidden name="hostInfoObj.id" id="id" />
			<table width="100%" border="0" cellspacing="0" class="pop-table nosize">
				...
				<tr>
					...
					<td>
						<s:select list="#{'0':'namenode','1':'datanode','2':'hmaster','3':'regionserver','4':'reducemanager','5':'nodemanager','6':'hive'}" name="hostInfoObj.service" id="service"></s:select>
					</td>
				</tr>
				<tr>
					<td class="til" align="left">
						CPU配置 (单位:个)<font color="red">*</font>
					</td>
					<td>
						<s:textfield name="hostInfoObj.cpu_ghz" id="cpu_ghz"></s:textfield>
					</td> 
				</tr>
				<tr>
					<td class="til" align="left">
				...
				<tr>
					<td class="til" align="left">
						HDFS存储总容量(单位:M) <font color="red">*</font>
					</td>
					<td>
						<s:textfield name="hostInfoObj.swap_size" id="swap_size"></s:textfield>
					</td> 
				</tr>
				<tr>
					<td class="til" align="left">
