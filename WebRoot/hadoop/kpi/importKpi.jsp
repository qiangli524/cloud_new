...
<s:form id="theForm" method="post" enctype="multipart/form-data" target="hidden_frame" action="HadoopKpi_importFromXls">
	<table  style="position:absolute;top:20px;">
		...
		<tr>
			<td>
			   <a href="<%=request.getContextPath()%>/hadoop/kpi/import_template.xls">下载模板</a>
			</td>
		</tr>
