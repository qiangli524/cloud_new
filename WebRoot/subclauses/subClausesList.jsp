...
<s:form action="service_subClausesList.do" method="post" cssStyle="theForm" id="theForm">
...
<div>
	...
	<div class="blue-wrap noborder">
		<div class="table-head">
		    <ul class="btns">
				<li><input id="addSubClauses"  type="button" class="thickbox btn-style02-75"  value="添加条目"  /></li>
				<li><input id="viewSubClauses"  type="button" class="thickbox btn-style02-75" value="修改条目"/></li>
				<li><input id="deleteSubClauses"  type="button" class="thickbox btn-style02-75" value="删除条目"/></li>
			</ul>
			...
			<table id="theTable" width="100%" class="blue-table sorttable" border="0" cellspacing="0">
			  ...
			  <tr>
                  ...
                  <!-- <th onclick="sort(theTable,2,'string')">服务权限</th>-->
                   <th onclick="sort(theTable,2,'string')">资源模板类别</th>
                   <th onclick="sort(theTable,3,'string')">资源模板名称</th>
                   <th onclick="sort(theTable,4,'string')">资源规格</th>
                   <th onclick="sort(theTable,5,'string')">服务说明</th>
	               <th onclick="sort(theTable,6,'string')">状态</th>
	               <th onclick="sort(theTable,7,'string')">有效时间</th>
	               <th onclick="sort(theTable,8,'string')">发布状态</th>
			  </tr>
			  </thead>
			  <tbody>
				 <s:iterator value="theForm.resultList"   id="theBean">	
						<tr>
							...
							<input name="checkboxid" type="checkbox"
			                   id='<s:property value="#theBean.id"/>'  />
							</td>
