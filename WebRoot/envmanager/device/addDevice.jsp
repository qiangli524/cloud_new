   ...
   function Trim(str){
	...
	function submitRequest(theForm) {
		...
		if (type == 1) {
			...
			var ph = document.getElementById('IP_PHYSICS').value;
			var ilo = document.getElementById('IP_ILO').value;
		...
		theForm.action = "condevice_saveDevice.do";
		theForm.submit();
	}
...
<s:form action="devicev_saveDevice.do" id="theForm" method="post"
	cssClass="theForm">
	...
	<s:hidden name="theForm.DEVICE_ID" id="DEVICE_ID" />
		<table width="100%" border="0" cellspacing="0"
			...
			<tr>
				...
				<td>
					<s:select list="#{'1':'主机'}" headerKey="" headerValue="-请选择-" name="theForm.DEVICE_TYPE" id="DEVICE_TYPE" onchange="loadDeviceInfo();"></s:select>
