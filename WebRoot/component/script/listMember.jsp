            ...
            <table id="theTable" width="100%" border="0" cellspacing="0" class="blue-table sorttable">
				<thead>
					<tr>
						...
						<th onclick="sort(theTable,3,'string')" width="10%">路径</th>
						<th onclick="sort(theTable,4,'string')">级别</th>
					</tr>
				</thead>
                <tbody>
                <s:iterator value="theForm.selectedList" id="selectedList">
                		<tr>
                			...
                			<td>
			  					...
			  					<s:elseif test="#selectedList.type==1">启动</s:elseif>
			  					<s:elseif test="#selectedList.type==2">停止</s:elseif>
			  					<s:elseif test="#selectedList.type==3">备份</s:elseif>
			  					<s:else>其他</s:else>
			  				</td>
                			<td align="center"><div class="hidden" title='<s:property value="#selectedList.path"/>'>
                				<s:property value="#selectedList.path"/></div></td>
                			<td><s:property value="#selectedList.grade"/></td>
                		</tr>
                	</s:iterator>
                </tbody>
			</table>
