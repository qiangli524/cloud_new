...
<script type="text/javascript" src="<%=request.getContextPath()%>/sxcloud/cjs/jquery/jquery-1.7.2.min.js"></script>
		...
		return str.replace(/^\s+|\s+$/g,"");
		 ...
		 function addprocess(){
		    ...
		    if(stop_script==null||Trim(stop_script)==""){
     		...
     		w.saveProcess($("#theForm").serialize(),selectUsers,userips,oper,example_ids,example_id,type1);
		 }
		 ...
		 $("[name='selectHost']").unbind().live("click",function(){
	  		w.$.dialog({
    			...
    			height: '470px',
    		    lock:true,
    			content: 'url:deployuser_list.do?userids='+selectUsers+'&example_id='+example_id+'&type='+type1+'&hostIP='+hostIP+'&example_ids='+example_ids
	    		});
		 });
    ...
    $(function(){
       $("#type option:eq(1)").attr("selected",true);
