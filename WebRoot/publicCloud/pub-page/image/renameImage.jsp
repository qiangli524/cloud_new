...
<head>
    ...
    <script type="text/javascript">
        ...
        function renameImg() {
            ...
            var url = "images_updateImage.do";
            w.renameImage(url, params);
        }
    </script>
</head>
<body>
<div class="thick-content">
    <form id="imageform">
        ...
        <div>
            ...
            <span class="font-red pdr-5">*</span>新名称: <input type="text" id="image_alias" name="obj.alias"
                                                             maxlength="20" class="input-1c"/>
        </div>
