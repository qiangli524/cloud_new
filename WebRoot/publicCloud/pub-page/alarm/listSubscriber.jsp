    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#add").unbind().live('click', function () {
                var url = "url:subscriber_createSubscriber.do";
                $.dialog({
                    id: 'addSubscriber',
                    title: '添加告警通知人',
                    //height: 60,
            ...
            $("#edit").unbind().live('click', function () {
                if ($('input[name="bb"]:checked').length == 1) {
                    ...
                    var url = "url:subscriber_updateSubscriberPage.do?obj.id=" + id;
                    $.dialog({
                        id: 'editSubscriber',
                        title: '修改告警通知人',
                        height: 510,
            ...
            function deleteSubscriber() {
                ...
                $.ajax({
                    url: "subscriber_deleteSubscriber.do?obj.id=" + ids,
                    type: "POST",
                    data: "text",
                    dataType: "json",
                    success: function (data) {
                        ...
                        if (data.result == "success") {
                            mask("删除告警通知人成功！", "success", 3000);
                            $("#theForm").submit();
                        } else {
                            mask("删除告警通知人失败！", "error", 3000);
                        }
                    }
                });
            }
        ...
        function saveSubscriber(url, params) {
            mask("正在保存告警通知人", "info");
            $.ajax({
                url: url,
                type: "POST",
                ...
                success: function (data) {
                    removeMask();
                    if (data.result == "success") {
                        mask("保存告警通知人成功！", "success", 3000);
                        $("#theForm").submit();
                    } else {
                        mask("保存告警通知人失败！", "error", 3000);
                    }
                }
            });
        }
        function updateSubscriber(url, params) {
            mask("正在更新告警通知人", "info");
            $.ajax({
                url: url,
                type: "POST",
                ...
                success: function (data) {
                    removeMask();
                    if (data.result == "success") {
                        mask("更新告警通知人成功！", "success", 3000);
                        $("#theForm").submit();
                    } else {
                        mask("更新告警通知人失败！", "error", 3000);
                    }
                }
            });
        }
...
<div class="container">
    ...
    <div class="col-c7">
        ...
        <div class="main-c1 fr">
            ...
            <!--标题 end-->
            <!--文字介绍 star-->
            <p class="p-con4">云服务监控用户管理 <font color="red"> </font> <a href="javascript:history.back();">返回</a></p>
            <!--文字介绍 end-->
            <!--pd-15 star-->
            <div class="pd-15">
                <div class="col-c8">
                    <form id="theForm" action="subscriber_list.do?type=<s:property value="type"/>" method="post">
                        <ul class="operate-list">
                            ...
                            <li class="search">
                                <input type="text" class="text-1" placeholder="姓名" name="obj.name" id="name"
                        ...
                        <table border="0" width="100%" class="table-f4 ">
                            ...
                            <s:iterator value="resultList" id="theBean">
                                <tr>
                                    ...
                                    <td><span class="font-blue"><s:property value="#theBean.phone"/></span></td>
                                    <td><span class="font-blue"><s:property value="#theBean.email"/></span></td>
                                    </td>
                                </tr>
                            </s:iterator>
                        </table>
