...
$(function(){
	...
	//修改
	 function updateprocess(){
	    ...
	    if(complete_rate==null || complete_rate=="" || complete_rate<0 || complete_rate>100){
			alert("请正确填写完成比例");
			return false;
		   }
	    //w.saveRecordList($("#theForm").serialize());
	    //找到父页面，并执行其中的方法
	     api.get("addRecords").updateRecordList($("#theForm").serialize());
	 }
});
</script>
</head>
	...
	<s:form action="" method="post" styleId="theForm" id="theForm">
		...
		<table width="100%" border="0" cellspacing="0"
			...
			<tr>
				...
				<td >
				<s:textarea  name="taskRecordObj.WORKCONTENT" cssClass="txt" id="workcontent" cols="45" rows="4" ></s:textarea>
				</td>
			</tr>
			<tr>
				<td class="til">配合人:</td>
			...
			<tr>
				...
				<td >
				<input id="complete_date" type="text" name="taskRecordObj.COMPLETE_DATE" size="32"  class="Wdate" value="${taskRecordObj.COMPLETE_DATE}"
			...
			<tr>
				...
				<td><s:textarea name="taskRecordObj.NOTE"
						cssClass="txt" id="note" cols="30" rows="6"></s:textarea>
				</td>
			</tr>
			</table>
		</s:form>
