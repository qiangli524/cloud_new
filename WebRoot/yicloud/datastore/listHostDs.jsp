	...
	var id = '<%=request.getAttribute("id")%>';
		 $("[name='add']").click(function(){
    		...
    		$.dialog({
    			...
    			max: true,
    		    min: true,
    			content: 'url:'+basePath+'datastore_addNFSPage.do?id='+id
    			});
              });
			});
			/*
...
<s:form action="datastore_listDataStore.do" method="post" id="theForm"
	...
	<div class="blue-wrap noborder">
		<div class="table-head">
		    <ul class="btns">
				<li><input type="button" class="thickbox btn-style02-100" value="增加网络存储"  name="add"/></li>
				<li> <a href="datastore_listHostDs.do?id=<%=id%>&name=<%=name%>">刷新数据存储</a> </li>
			</ul>
		</div>
		<div class="table-ct">
				...
				<tbody>
					<s:iterator value="theForm.resultList" id="theBean">
						<tr>
							...
							<td><s:property value = "#theBean.CAPACITY"/>(GB)</td>
							<td><s:property value = "#theBean.FREE_SPACE"/>(GB)</td>
