...
$(function(){
	...
	$(function() {
		$("#file").uploadify({
			...
			uploader      : 'opersystem_saveOperSystem.do',
			fileTypeExts  :'*.tar;*.zip;*.gz',
            ...
            onUploadSuccess : function(file) {
            	theForm.action ='opersystem_saveOperSystem.do?b=' +true+'&name='+encodeURI(encodeURI(file.name));
            	theForm.submit();
            }
...
<s:form action="opersystem_saveOperSystem.do" method="post" id="theForm" enctype="multipart/form-data">
		...
		<s:hidden name="theForm.ID" id="ID"></s:hidden>			   
			...
			<table width="100%" border="0" cellspacing="0" class="pop-table nosize">
				<tr>
				    <td class="til">
						请选择上传的操作系统文件 <font color="red">*</font>
					</td>
					<td>
