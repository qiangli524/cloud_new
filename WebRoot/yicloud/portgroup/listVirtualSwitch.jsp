		...
		$(".query").click(function(){
		 ...
		 $("[name='add']").click(function(){
    		...
    		$.dialog({
    		    ...
    		    min: true,
    		    lock:true,
    			content: 'url:'+basePath+'portgroup_addNetWork.do'
    			});
              });
...
<div class="scrollbody">
	...
	<table width="100%" class="querytable" border="0">
		<tr>
			<td class="til">虚拟交换机名称:</td>
			<td>
				<s:textfield name="theVSForm.name" id="name"></s:textfield>
			</td>
		</tr>
		<tr>
			<td colspan="8" class="btns">
			<div><input type="button" class="thickbox btn-style02"
				value="查询" onclick="searchRequest();" /> <input
 ...
 <div class="table-ct">
			<table width="100%" class="blue-table sorttable" border="0" cellspacing="0" id="theTable">
			  ...
			  <tr>
					...
					<th onclick="sort(theTable,4,'string')">所属</th>
			  ...
			  <s:iterator value="theVSForm.resultList" id="theBean">
			  	<tr>
			  		...
			  		<s:if test="#theBean.numNic>0">
						<td><a href="javascript:;" vssUuid='<s:property value="#theBean.vssuuid"/>' vssName='<s:property value="#theBean.name"/>' vssType='<s:property value="#theBean.type"/>'  name="listNic"><s:property value="#theBean.numNic"/></a></td>			  			
			  		</s:if>
			  		<s:else>
