...
<script type="text/javascript">
	...
	function searchRequest() { 
 	...
 	function addRequest() {
 	    theForm.action = 'osTemplComp_addOsTemplateGroupUser.do' 
		theForm.submit();
 	}
	...
	function modRequest() { 
		...
		theForm.action = 'osTemplComp_updateOsTemplateGroupUser.do' 
		theForm.submit();
	}
	...
	function delRequest() {
		...
		if(confirm("确定要删除?")){
			theForm.action = 'osTemplComp_deleteOsTemplateGroupUser.do'  
			theForm.submit();
		}
	}
...
<body>
<div class="mainbody">
<s:form action="osTemplComp_showOsTemplateGroupUser.do" method="post" cssStyle="theForm" id="theForm">
...
<s:hidden name="theForm.template_id" id="template_id"></s:hidden>
		 <div class="pd-20 bgcolor-1">
			...
			<div class="clearfix mgt-10">
				<label class="vm">组标识：</label>
				<s:textfield name="theForm.group_id" id="group_id" cssClass="inpt-2" maxlength="30"></s:textfield>
				<label class="mgl-20 vm">用户标识：</label>
				<s:textfield name="theForm.user_id" id="user_id" maxlength="30" cssClass="inpt-2" ></s:textfield>
			...
			<table id="theTable" width="100%" class="blue-table sorttable" border="0" cellspacing="0">
			  ...
			  <tr>
				   <th width="5%">编号</th>
				   <th width="30%" onclick="sort(theTable,0,'string')">用户名</th>   
