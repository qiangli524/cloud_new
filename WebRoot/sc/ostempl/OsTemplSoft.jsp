...
<script type="text/javascript">
	...
	function resetForm(theForm){
		theForm.soft_name.value = '';
		theForm.soft_type.value = '';
	}
	...
	function searchRequest() { 
 	...
 	function addRequest() {
 	    theForm.action = 'osTemplComp_addOsTemplateSoft.do' 
		theForm.submit();
 	}
	...
	function modRequest() { 
		...
		theForm.action = 'osTemplComp_updateOsTemplateSoft.do' 
		theForm.submit();
	}
	...
	function delRequest() {
		...
		if(confirm("确定要删除?")){
			theForm.action = 'osTemplComp_deleteOsTemplateSoft.do'  
			theForm.submit();
		}
	}
...
<body>
<div class="mainbody">
<s:form action="osTemplComp_showOsTemplateSoft.do" method="post" cssStyle="theForm" id="theForm">
<s:hidden name="theForm.id" id="id"></s:hidden>
<s:hidden name="theForm.template_id" id="template_id"></s:hidden>
		 <div class="pd-20 bgcolor-1">
			<h2 class="utt-1">软件包配置</h2>
			<div class="bord-1 pd-10">			
			<div class="clearfix mgt-10">
				<label class="vm">名称：</label>
				<s:textfield name="theForm.soft_name" id="soft_name" cssClass="inpt-2" maxlength="30"></s:textfield>
				<label class="mgl-20 vm">类型：</label>
				<s:textfield name="theForm.soft_type" id="soft_type" maxlength="30" cssClass="inpt-2" ></s:textfield>
			...
			<table id="theTable" width="100%" class="blue-table sorttable" border="0" cellspacing="0">
			  ...
			  <tr>
				   <th width="5%">编号</th>
				   <th width="40%" onclick="sort(theTable,0,'string')">软件名称</th>   
                   <th width="20%" onclick="sort(theTable,1,'string')">类别</th>
                   <th width="35%" onclick="sort(theTable,2,'string')">备注</th>
			  </tr>
			  </thead>
			  <tbody>
