	...
	<div class="pd-20 bgcolor-1">
      <h2 class="utt-1">文件系统配置</h2>
         <div class="bord-1 pd-10">
			<s:form action="osFileSystem_modifyFileSystem.do" method="post" cssStyle="theForm" id="theForm">
				...
				<s:hidden name="theForm.os_host_id" id="os_host_id"></s:hidden>
					<table width="100%" border="0" cellspacing="0" class="pop-table nosize">						
						<tr>
							...
							<td>
								<s:textfield name="theForm.filesys_name" id="filesys_name" maxlength="30" cssClass="required inpt-2"/>            
							</td>
							<td class="til">
						...
						<tr>
							<td colspan="4" class="btnCenter">
								<span class="ubtn-green"><input type="button" id="updateButton"  value="确定"/></span>
