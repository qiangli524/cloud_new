...
<script type="text/javascript">
	$(function(){
		...
		$('#subBusinessId').val('${obj.subBusinessId}');
	})
...
<body >
<div class="mainbody">
<s:form action="customReport_vmlist.do" method="post" cssClass="theForm" id="theForm">
		...
		<div class="bord-1 pd-10">
			...
			<tr>	
             ...
             <tr> 
                ...
                <td>
                   	<input type="text" id="vhName" name="obj.vhName" class="inpt-1 fl" value="${obj.vhName}"/>
                </td>
             </tr>
             <tr>
                 <td colspan="10">
			...
			<table id = "theTable" width="100%" class="blue-table sorttable" border="0" cellspacing="0">
			  ...
			  <s:iterator value="objList" id="theBean">
			  	<tr>
			  		...
			  		<td >
			  		    <s:property value="#theBean.subBusi" default="-"/>
                    </td>
			  	</tr>
			  	</s:iterator>
			  </tbody>
