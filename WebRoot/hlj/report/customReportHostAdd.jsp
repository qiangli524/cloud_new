...
<body>
	<div style="width:70%;height:95%">
		<iframe style="width: 100%;height:100%" src="customReport_hostlist.do?obj.dataCenterId=${obj.dataCenterId}&obj.clusterId=${obj.clusterId}" name="vmAdd" frameborder="0">Load Failed?</iframe>
	</div>
	...
	<div style="width:18%;height:90%" id="addVm" ><br/><br/>
		已添加的主机：<div style="overflow-y:auto;
