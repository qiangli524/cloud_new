    	...
    	function addVmhost(){
			...
			for(i=0;i<boxs.length;i++){
					if(boxs[i].checked==true ){
						...
						if(boo){
							vmIds = vmIds+vmId+",";
							vmNames = vmNames+"<div name='vn' id='' style='padding:2px;float:none'  onclick='mclick(this);' onmouseover='mover(this);' onmouseout='mout(this);' >"+vmName+"<input type='hidden' title='"+vmName+"' name='hiid' t value="+vmId+"><br/></div>";//用于展示							
						}
						boo=true;
					}
	     	}
...
<body>
	<div style="width:70%;height:95%">
		<iframe style="width: 100%;height:100%" src="customReport_vmlist.do?obj.dataCenterId=${obj.dataCenterId}&obj.businessId=${obj.businessId}&obj.clusterId=${obj.clusterId}&obj.subBusinessId=${obj.subBusinessId}" name="vmAdd" frameborder="0">Load Failed?</iframe>
	</div>
